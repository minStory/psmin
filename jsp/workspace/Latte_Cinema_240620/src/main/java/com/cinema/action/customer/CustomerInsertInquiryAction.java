...
public class CustomerInsertInquiryAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response)
		...
		String writer_no = "비회원";
		String writer_id = "비회원";

		if (session.getAttribute("dto") != null) {
			MemberDTO mDto = (MemberDTO) session.getAttribute("dto");
			writer_no = mDto.getMember_no();
			writer_id = mDto.getMember_id();
		}

		String saveFolder = "C:\\Users\\psm90\\Desktop\\psmin\\jsp\\workspace\\Latte_Cinema\\src\\main\\webapp\\images\\customer_inquiry";
