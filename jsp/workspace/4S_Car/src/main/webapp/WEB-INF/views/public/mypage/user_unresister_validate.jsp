...
<body>
	...
	<div class="modify_container">
		<form class="modify_passwordform" method="post"
			action="user_unresister_ok">
					...
					<div>
						...
						<div class="myinfo_password_inner">
							...
							<div class="inner_password">
								<input type="password" id="modify_password" name="check_pwd"
									placeholder="비밀번호를 입력해주세요." required>
								<button type="submit" class="modify_password_click">확인</button>
							</div>
						</div>
