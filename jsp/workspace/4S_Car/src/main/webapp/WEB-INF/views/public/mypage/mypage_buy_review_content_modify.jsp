	...
	<div class="car_mypage">
		...
		<div class="car_registration_menual">
			...
			<div class="car_myreview_board_content">
				<div align="center">
					<form method="post" action="mypage_buy_review_content_modify_ok"
						enctype="multipart/form-data">
						<input type="hidden" name="board_no"
							value="${cont.getBuy_review_board_no() }"> <input
							type="hidden" name="title"
							value="${cont.getBuy_review_board_title() }"> <input
							type="hidden" name="writer_id"
							value="${cont.getBuy_review_board_writer_id() }"> <input
							type="hidden" name="content"
							value="${cont.getBuy_review_board_cont() }"> <input
							type="hidden" name="modify_date"
							value="${cont.getBuy_review_board_date() }"> <input
							type="hidden" name="file"
							value="${cont.getBuy_review_board_file() }">
						...
						<table class="car_myreview_board_content_table" border="1"
							...
							<tr>
								...
								<td><input type="text" class="content_input"
									name="board_no" value=${cont.getBuy_review_board_no() }
									readonly></td>
								<th>작성자</th>
								<td><input type="text" id="content_title" name="user_id"
									value="${cont.getBuy_review_board_writer_id()}" readonly /></td>

								<th>수정일</th>
								<td><input class="content_input" name="modify_date"
									value="${cont.getBuy_review_board_date().substring(0,10)}"
									readonly></td>
							</tr>
							...
							<tr>
								...
								<td colspan="3"><input type="text" class="content_input"
									name="title" value="${cont.getBuy_review_board_title()}" /></td>
								...
								<td colspan="5">
									<div class="content_input_cont_div">
										<textarea class="content_input_cont" name="content" rows="50"
											cols="50">${cont.getBuy_review_board_cont() }</textarea>
									</div>
								</td>
								...
								<td colspan="5">
									<div class="filebox">
										<input class="upload-name"
											value="${cont.getBuy_review_board_file() }"
											placeholder="첨부파일" name="file"> <label for="file">파일찾기</label>
