...
public class MypageQnaContentDeleteAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response)
		...
		int check = dao.delete_mypageqnacontent(qna_no);

		if (check > 0) {

			ActionForward forward = new ActionForward();

			forward.setPath("/WEB-INF/views/public/mypage/mypage_qna_content_delete_ok.jsp");
