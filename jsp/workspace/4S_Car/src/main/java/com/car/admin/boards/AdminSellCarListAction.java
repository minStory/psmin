...
public class AdminSellCarListAction implements Action {
   ...
   public ActionForward execute(HttpServletRequest request, HttpServletResponse response)
      ...
      cnt = dao.countSellCarBoardList(dto.getAdmin_no());
      ...
      List<SellBoardDTO> list = dao.getSellCarBoardList(dto.getAdmin_no(), page, rowsize);
