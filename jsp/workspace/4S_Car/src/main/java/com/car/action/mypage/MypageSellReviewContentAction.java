...
public class MypageSellReviewContentAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response)
		...
		SellReviewBoardDTO cont = dao.getSellReviewBoardContent(review_board_no);
		...
		forward.setPath("/WEB-INF/views/public/mypage/mypage_sell_review_content.jsp");
