	...
	<div align="center">
		...
		<table border="1" width="500px">
			...
			<tr>
				...
				%>
				<th>작성일자</th>
				<td align="center"><%=board.getBoard_date() %></td>
						
				<%	}else{ %>
				<th>수정일자</th>
				<td align="center"><%=board.getBoard_update() %></td>
			<%		
				}
			%>
				<th>조회수</th>
				...
				<td colspan="3" align="center">
					<%=board.getBoard_title() %></td>
		
			<tr>
				<th>글내용</th>
				<td colspan="3" height="100px">
					<%--  <textarea rows="7" cols="25" readonly="readonly"><%=board.getBoard_cont() %></textarea> --%>
